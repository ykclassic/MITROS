...
class EventType(StrEnum):
    ...
    STRATEGY_PERFORMANCE_UPDATED="StrategyPerformanceUpdated"; MODEL_VALIDATED="ModelValidated"; MODEL_PROMOTED="ModelPromoted"; MODEL_PREDICTION_GENERATED="ModelPredictionGenerated"; MODEL_DRIFT_DETECTED="ModelDriftDetected"
